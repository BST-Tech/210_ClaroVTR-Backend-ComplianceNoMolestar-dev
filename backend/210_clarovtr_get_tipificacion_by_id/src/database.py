...
def get_tipificacion_by_id(uid, tipificacion_id):
    ...
    #    email = get_user_by_id(uid)
    query = f"""
	select t.id, t.tipificacion, t.nombre_tipificacion, t.contacto, t.venta, t.id_empresa_ct, ecc.id_contact_center from tipificacion t join empresa_contact_center ecc
